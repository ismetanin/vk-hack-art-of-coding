...
@IBDesignable open class Switch: UIControl {
    ...
    lazy var selectedTextColor: UIColor = tintColor
    lazy var disabledTextColor: UIColor = disabledColor
    ...
    func reloadLabelsTextColor() {
        leftLabel.textColor = rightSelected ? disabledTextColor : selectedTextColor
        rightLabel.textColor = rightSelected ? selectedTextColor : disabledTextColor
    }
