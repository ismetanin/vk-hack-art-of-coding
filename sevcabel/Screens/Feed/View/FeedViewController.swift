...
final class FeedViewController: UIViewController {
    ...
    private func configurePageController() {
        ...
        let items2: [FeedItem] = [
            FeedItem(title: "Meat Up",
                     subtitle: "Стритфуд",
                     image: UIImage(named: "meet_up")!,
                     fullImage: UIImage(named: "meet_up_full")!,
                     description: """
                    Meat Up Burgers - обитель мяса твоей мечты. Самые сочные куски, самые ароматные булки и все такое.

                    Птицы отправляются на юг. Охотники за лучшими бургерами – в порт «Севкабель».

                    Помнишь, мама говорила – хватит есть всухомятку? В Meat Up Burgers ешь, как хочешь: сочные бургеры, салаты, картошечка, супы – выбирай свое комбо

                    Смотри не слети с катушек! Такое вполне возможно после того, как попробуешь огромные бургеры в Meat Up!
                    """,
                     isEvent: false,
                     isRegistered: false
            ),
            ...
            FeedItem(title: "EASY HUMMUS",
                     subtitle: "Стритфуд",
                     image: UIImage(named: "hummus")!,
                     fullImage: UIImage(named: "hummus_full")!,
                     description: """
                    Питерская хумусия №1🇮🇱
                    Порт Севкабель В.О. Кожевенная линия д.40🥙🌯

                    Фалафель для израильтян - все равно, что гамбургер или хот-дог для современных американцев. Можно сказать и так: лоточник с фалафелем в Израиле так же обязателен, как и лоточник с жареными каштанами во Франции. Как бы ни было, это ОЧЕНЬ вкусно😋😋😋 И любителей фалафеля становится все больше
                    """,
                     isEvent: false,
                     isRegistered: false
            )
